...
from app.api.v1.endpoints import assistant, auth, driver, drivers, health, mobility_profile, onboarding, platform_admin, transport_options, transport_requests, vehicles
